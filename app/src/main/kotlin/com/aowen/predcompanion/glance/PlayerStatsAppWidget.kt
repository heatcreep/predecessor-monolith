...
import com.aowen.predcompanion.glance.state.PlayerStatsState
import com.aowen.predcompanion.glance.state.PlayerStatsStateDefinition
import com.aowen.predcompanion.glance.ui.MediumPlayerStatsNotSet
import com.aowen.predcompanion.glance.ui.MediumPlayerStatsSuccess
import com.aowen.predcompanion.glance.ui.PlayerStatsAppWidgetColorScheme
import com.aowen.predcompanion.glance.ui.SmallPlayerStatsError
import com.aowen.predcompanion.glance.ui.SmallPlayerStatsNotSet
import com.aowen.predcompanion.glance.ui.SmallPlayerStatsSuccess
import com.aowen.predcompanion.glance.utils.getImageProvider
...
class PlayerStatsAppWidget : GlanceAppWidget() {
    ...
    private fun SmallScreen(
        ...
        Box(
            ...
            Image(
                provider = ImageProvider(coreResources.drawable.small_widget_background),
