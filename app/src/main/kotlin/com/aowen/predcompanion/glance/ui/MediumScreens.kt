package com.aowen.predcompanion.glance.ui
...
import com.aowen.monolith.glance.ui.Divider
...
fun MediumPlayerStatsSuccess(
    ...
    Column(
        ...
        Row(
            modifier = GlanceModifier
                ...
                .clickable(
                    actionStartActivity(
                        Intent(
                            Intent.ACTION_VIEW,
                            "monolith://player-detail/$playerId".toUri()
                        ).apply {
            ...
            Image(
                provider = ImageProvider(coreResources.drawable.refresh_36),
                modifier = GlanceModifier
        ...
        Column(
            ...
            Column(modifier = GlanceModifier.fillMaxWidth()) {
                StatRow(
                    ...
                    statValue = playerStats.matchesPlayed
                )
                Divider()
            }
            Column(modifier = GlanceModifier.fillMaxWidth()) {
            ...
            Column(modifier = GlanceModifier.fillMaxWidth()) {
                StatRow(
                    ...
                    statValue = playerStats.favoriteRole
                )
                Divider()
            }
            KdaStatRow(statValue = playerStats.averageKda)
        }
    }
}
...
fun RowScope.MediumPlayerStatsNotSet(
    ...
    Row(
        ...
        Image(
            provider = ImageProvider(coreResources.drawable.add_circle_24),
