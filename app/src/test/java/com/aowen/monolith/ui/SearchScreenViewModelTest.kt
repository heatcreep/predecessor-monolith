...
import com.aowen.predcompanion.feature.search.AllHeroesState
import com.aowen.predcompanion.feature.search.AllItemsState
import com.aowen.predcompanion.feature.search.SearchScreenUiState
import com.aowen.predcompanion.feature.search.SearchScreenViewModel
...
class SearchScreenViewModelTest {
    ...
    fun `Items Fail - initViewModel() should update error state properly if items fail to load`() =
        runTest {
            ...
            coEvery { itemRepository.fetchAllItems() } returns Resource.NetworkError(
                404,
