...
fun ModuleEditOrderRoute(
    ...
    _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.ModuleEditOrderScreen(
        uiState = uiState,
            ...
            LazyColumn(
                ...
                itemsIndexed(uiState.modules) { index, module ->
                    DraggableItem(
                        ...
                        _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.ModuleItemCard(
                            itemModule = module,
                            onEdit = {
