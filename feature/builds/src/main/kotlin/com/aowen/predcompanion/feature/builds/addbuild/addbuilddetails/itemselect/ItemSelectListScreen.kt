...
import com.aowen.monolith.ui.shared.SearchBar
import com.aowen.monolith.ui.shared.StatFilterDropdown
import com.aowen.monolith.ui.shared.TierFilterDropdown
import com.aowen.monolith.ui.shared.defaultStats
...
fun ItemSelectListRoute(
    ...
    when (itemType) {
        ItemType.Crest -> _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.itemselect.CrestSelectListScreen(
            ...
            _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.itemselect.ItemSelectListScreen(
                buildSection = buildSection,
                allItems = items,
        ...
        Surface(
            ...
            LazyColumn(
                ...
                items(crestGroups) { crestGroup ->
                    _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.itemselect.CrestGroup(
            ...
            Column(
                ...
                LazyVerticalGrid(
                    ...
                    items(getFilteredItems()) {
                        _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.addbuilddetails.itemselect.ItemSelectListItem(
                            item = it,
