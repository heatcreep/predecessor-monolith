package com.aowen.predcompanion.feature.builds.addbuild
...
import com.aowen.monolith.navigation.navigateToAddBuildDetails
...
fun HeroAndRoleSelectionRoute(
    ...
    navigateBack: () -> Unit,
    navigateToAddBuildDetails: () -> Unit
) {

    val uiState by viewModel.uiState.collectAsState()

    _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.HeroAndRoleSelectionScreen(
        uiState = uiState,
    ...
    Scaffold(
        ...
        Surface(
            ...
            Column(
                ...
                _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.RoleSelection(
                ...
                if (uiState.isLoadingHeroes) {
                    ...
                    _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.HeroSelection(
...
fun RoleSelection(
    ...
    Row(
        ...
        HeroRole.entries.filter {
            ...
            _root_ide_package_.com.aowen.predcompanion.feature.builds.addbuild.RoleButton(
                modifier = Modifier.weight(1f),
