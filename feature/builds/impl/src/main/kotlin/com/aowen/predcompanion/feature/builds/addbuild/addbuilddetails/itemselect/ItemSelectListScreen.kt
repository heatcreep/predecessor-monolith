...
import com.aowen.predcompanion.core.ui.shared.StatFilterDropdown
import com.aowen.predcompanion.core.ui.shared.TierFilterDropdown
import com.aowen.predcompanion.core.ui.shared.defaultStats
import com.aowen.predcompanion.data.ItemDetails
import com.aowen.predcompanion.data.SlotType
import com.aowen.predcompanion.feature.builds.addbuild.AddBuildViewModel
import com.aowen.predcompanion.feature.builds.addbuild.CrestGroupDetails
import com.aowen.predcompanion.feature.builds.addbuild.CrestType
                ...
                LazyVerticalGrid(
                    ...
                    items(getFilteredItems()) {
                        ItemSelectListItem(
                            ...
                            onItemLongPressed = { itemDetails ->
                                currentlyOpenItem = itemDetails
