...
fun MoreMatchesRoute(
    ...
    MoreMatchesScreen(
        ...
        onMatchClicked = navigateToMatchDetails
    )
}
                                ...
                                FilterDropdown(
                                    ...
                                    onSelectOption = {
                                        onSelectTimeFrameFilter(
                                            TimeFrame.entries.first { timeFrame ->
                                                timeFrame.description == it
                                            }
                                        )
                                    },
                                ) {
            ...
            is LoadState.Error -> {
                ...
                LazyColumn(
                    ...
                    items(matches.itemCount) { index ->
                        matches[index]?.let { matchItem ->
                            MatchPlayerCard(
                                modifier = Modifier.clickable {
                                    onMatchClicked(matchItem.playerId, matchItem.matchId)
                                },
