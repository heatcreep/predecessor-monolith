...
import com.aowen.monolith.core.resources.R
...
enum class RankDetails(
    ...
    BRONZE_III("Bronze III", R.drawable.bronze_200, Bronze),
    BRONZE_II("Bronze II", R.drawable.bronze_200, Bronze),
    BRONZE_I("Bronze I", R.drawable.bronze_200, Bronze),
    SILVER_III("Silver III", R.drawable.silver_200, Silver),
    SILVER_II("Silver II", R.drawable.silver_200, Silver),
    SILVER_I("Silver I", R.drawable.silver_200, Silver),
    GOLD_III("Gold III", R.drawable.gold_200, Gold),
    GOLD_II("Gold II", R.drawable.gold_200, Gold),
    GOLD_I("Gold I", R.drawable.gold_200, Gold),
    PLATINUM_III("Platinum III", R.drawable.platinum_200, Platinum),
    PLATINUM_II("Platinum II", R.drawable.platinum_200, Platinum),
    PLATINUM_I("Platinum I", R.drawable.platinum_200, Platinum),
    DIAMOND_III("Diamond III", R.drawable.diamond_200, Diamond),
    DIAMOND_II("Diamond II", R.drawable.diamond_200, Diamond),
    DIAMOND_I("Diamond I", R.drawable.diamond_200, Diamond),
    PARAGON("Paragon", R.drawable.paragon_200, Paragon),
}
